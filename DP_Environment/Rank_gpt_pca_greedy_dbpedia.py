...
try:
    ...
    BASE_DIR = Path.cwd()
ART_DIR = BASE_DIR / "noisy_gpt_DBP" / "artifacts"
RESULTS_DIR = BASE_DIR / "noisy_gpt_DBP" / "checkpoints"
...
def _client_dir(cid: int, rank: int) -> str:
    # d = os.path.join(ART_DIR, f"client_{cid}_dbpedia_01")
    d = os.path.join(ART_DIR, f"client_{cid}_rank_{rank}_dbpedia")
...
if __name__ == "__main__":
    ...
    # sigmas = [0.662 * SIGMA_MAX] * num_clients
